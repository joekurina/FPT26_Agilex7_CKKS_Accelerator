# This is the top level tcl file for 'ifft8k_base_DUT'
...
if {!$overwrite_opt && [project_exists ifft8k_base_DUT]} {
    puts "The ifft8k_base_DUT quartus project already exists."
    puts "Use 'overwrite option' to force project to be over-written/"
} elseif {![file exists "./ifft8k_4lanes_double_261/ifft8k_base/ifft8k_base_DUT.tcl"]}    {
    puts "You must run ifft8k_base_DUT.tcl "
...
puts "Creating ifft8k_base_DUT Quartus project..."

if $overwrite_opt {
    project_new -overwrite ifft8k_base_DUT
} else {
    project_new ifft8k_base_DUT
}

set_global_assignment -name FAMILY "Agilex 7"
set_global_assignment -name TOP_LEVEL_ENTITY ifft8k_base_DUT
set_global_assignment -name DEVICE AGFB014R24A1E1V
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE ./ifft8k_4lanes_double_261/ifft8k_base/ifft8k_base_DUT.sdc
set_global_assignment -name SYNCHRONIZATION_REGISTER_CHAIN_LENGTH 1
set_global_assignment -name FLOW_DISABLE_ASSEMBLER ON
source ./ifft8k_4lanes_double_261/ifft8k_base/ifft8k_base_DUT.add.tcl

set_instance_assignment -name VIRTUAL_PIN ON -to v_in_s
set_instance_assignment -name VIRTUAL_PIN ON -to channel_in_s
set_instance_assignment -name VIRTUAL_PIN ON -to data_in_0re
set_instance_assignment -name VIRTUAL_PIN ON -to data_in_0im
set_instance_assignment -name VIRTUAL_PIN ON -to data_in_1re
set_instance_assignment -name VIRTUAL_PIN ON -to data_in_1im
set_instance_assignment -name VIRTUAL_PIN ON -to data_in_2re
set_instance_assignment -name VIRTUAL_PIN ON -to data_in_2im
set_instance_assignment -name VIRTUAL_PIN ON -to data_in_3re
set_instance_assignment -name VIRTUAL_PIN ON -to data_in_3im
set_instance_assignment -name VIRTUAL_PIN ON -to v_out_s
set_instance_assignment -name VIRTUAL_PIN ON -to data_out_0re
set_instance_assignment -name VIRTUAL_PIN ON -to data_out_0im
set_instance_assignment -name VIRTUAL_PIN ON -to data_out_1re
set_instance_assignment -name VIRTUAL_PIN ON -to data_out_1im
set_instance_assignment -name VIRTUAL_PIN ON -to data_out_2re
set_instance_assignment -name VIRTUAL_PIN ON -to data_out_2im
set_instance_assignment -name VIRTUAL_PIN ON -to data_out_3re
set_instance_assignment -name VIRTUAL_PIN ON -to data_out_3im
set_instance_assignment -name VIRTUAL_PIN ON -to areset

source "./ifft8k_4lanes_double_261/ifft8k_base/ifft8k_base_DUT_fpc.add.tcl"
