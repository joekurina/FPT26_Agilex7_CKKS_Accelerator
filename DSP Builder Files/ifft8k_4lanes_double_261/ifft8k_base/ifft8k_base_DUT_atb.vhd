...
entity ifft8k_base_DUT_atb is
end;

architecture normal of ifft8k_base_DUT_atb is

component ifft8k_base_DUT is
    port (
        v_in_s : in std_logic_vector(0 downto 0);  -- ufix1
        channel_in_s : in std_logic_vector(7 downto 0);  -- sfix8
...
component ifft8k_base_DUT_stm is
    port (
...
sim : ifft8k_base_DUT_stm port map (
    v_in_s_stm,
    channel_in_s_stm,
    data_in_0re_stm,
    data_in_0im_stm,
