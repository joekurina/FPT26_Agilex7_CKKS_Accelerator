...
void set_disabled_mp_allocators() noexcept;
#endif
...
struct mp_temp_allocator
{
    ...
    mp_int& alloc_int()
    {
        if (m_stack[m_stack_pos].int_offset >= max_offset)
        {
    ...
    {
        if (m_stack[m_stack_pos].float_offset >= max_offset)
        {
            fatal("Multi-precision temporary allocator exhausted");
        }
...
private:
    ...
    static constexpr size_t max_offset = capacity - 1;
...
#ifdef CSL_USE_MPFR
float fp_mul_impl(const float& a, const float& b) noexcept;
#endif
...
void step_lookup(const int64_t* values, uint64_t n, uint64_t offset, int64_t& iq, int64_t ia_in);
void step_lookup_with_valid(const int64_t* values, uint64_t n, uint64_t offset, int64_t& iq, int64_t& ivalid, int64_t ia_in);
void step_lookup_hash(const int64_t* values, uint64_t n, uint64_t mult, int64_t& iq, int64_t ia_in);
void step_lookup_hash_with_valid(const int64_t* values, uint64_t n, uint64_t mult, int64_t& iq, int64_t& ivalid, int64_t ia_in);
...
void step_logical_finalize_inv(mp_int& q, int bit_width_in, int bit_width_out, bool has_signed_in, bool has_signed_out) noexcept;
...
void step_sequencer(mp_int& state, mp_int& iq, const mp_int& ia, size_t offset, int64_t mod, int64_t cross,
                    mp_temp_allocator& alloc) noexcept;
...
void step_lookup_with_valid(const uint64_t* values, const mp_int_info* infos, uint64_t n, uint64_t offset, mp_int& iq, mp_int& ivalid,
                            int64_t ia_in, mp_temp_allocator& alloc);
void step_lookup_hash(const int64_t* values, uint64_t n, uint64_t mult, mp_int& iq, int64_t ia_in);
...
void step_lookup_hash(const uint64_t* values, const mp_int_info* infos, uint64_t n, uint64_t mult, mp_int& iq, int64_t ia_in,
                      mp_temp_allocator& alloc);
void step_lookup_hash_with_valid(const int64_t* values, uint64_t n, uint64_t mult, int64_t& iq, mp_int& ivalid, int64_t ia_in);
void step_lookup_hash_with_valid(const int64_t* values, uint64_t n, uint64_t mult, mp_int& iq, int64_t& ivalid, int64_t ia_in);
void step_lookup_hash_with_valid(const int64_t* values, uint64_t n, uint64_t mult, mp_int& iq, mp_int& ivalid, int64_t ia_in);
...
void step_decode(mp_int& iq0, mp_int& iq1, const mp_int& ia, const mp_int& ib, int32_t low, int32_t high, int32_t decode,
                 mp_temp_allocator& alloc) noexcept;
void step_fp_acc(int64_t& iacc, int64_t control, int64_t& iq, int64_t ix, mp_temp_allocator& alloc) noexcept;
void step_fp_acc(mp_int& iacc, int64_t control, int64_t& iq, int64_t ix, mp_temp_allocator& alloc) noexcept;
