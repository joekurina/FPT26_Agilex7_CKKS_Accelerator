...
entity flt_ifft8k_base_DUT_addSubFusedBlock_typeSFloatIEEE_52_11_4_correctRounding_38560000x0ao30cd06cj6ok0dpzc_atb is
end;

architecture normal of flt_ifft8k_base_DUT_addSubFusedBlock_typeSFloatIEEE_52_11_4_correctRounding_38560000x0ao30cd06cj6ok0dpzc_atb is

component flt_ifft8k_base_DUT_addSubFusedBlock_typeSFloatIEEE_52_11_4_correctRounding_38560000x0ao30cd06cj6ok0dpzc is
    port (
...
component flt_ifft8k_base_DUT_addSubFusedBlock_typeSFloatIEEE_52_11_4_correctRounding_38560000x0ao30cd06cj6ok0dpzc_stm is
    port (
        in_0_stm : out std_logic_vector(63 downto 0);
        in_1_stm : out std_logic_vector(63 downto 0);
        out_primWireAux_stm : out std_logic_vector(63 downto 0);
...
signal out_primWireAux_stm : STD_LOGIC_VECTOR (63 downto 0);
...
signal out_primWireAux_dut : STD_LOGIC_VECTOR (63 downto 0);
...
dut : flt_ifft8k_base_DUT_addSubFusedBlock_typeSFloatIEEE_52_11_4_correctRounding_38560000x0ao30cd06cj6ok0dpzc port map (
    in_0_stm,
    in_1_stm,
    out_primWireAux_dut,
    out_primWireOut_dut,
...
sim : flt_ifft8k_base_DUT_addSubFusedBlock_typeSFloatIEEE_52_11_4_correctRounding_38560000x0ao30cd06cj6ok0dpzc_stm port map (
    in_0_stm,
    in_1_stm,
    out_primWireAux_stm,
    out_primWireOut_stm,
